  ...
  .controller('RegisterCtrl', ['$scope', '$http' , 'RegisterResources', '$resource',
    function ($scope, $http, RegisterResources, $resource) {
      ...
      $scope.saveUser = function(){
        ...
        User.save({'name':$scope.provider.firstName, 'surname': $scope.provider.surName, 'email': $scope.provider.email, 'phone': $scope.provider.telephone, 'dni': $scope.provider.document, 'version': "0"}, function(response){
